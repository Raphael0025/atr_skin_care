            ...
            <section className='container d-flex justify-content-center align-items-center mt-5 px-5'>
                <div className='p-5 text-light rounded-5 background-form col-5'>
                    <div className='d-flex'>
                        <h3 className='p-2 border-bottom border-3 border-warning'><strong>Log In</strong></h3>
                    </div>
                    <form>
                        ...
                        <div className='d-flex mt-2 justify-content-end p-0 pt-2 container'>
                            <Link to='/auth/forgot-password' className='text-warning text-decoration-none'><span className='lnk txt'>Forgot Password?</span></Link>
                        </div>
                        <div className='d-flex justify-content-end p-0 pt-2 container'>
                            <button type='submit' className='btn btn-outline-warning px-4'><strong>Log In</strong></button>
                        </div>
                        <div className='d-flex align-items-center justify-content-start p-0 container'>
                            ...
                            <Link to='/auth/register' className='text-warning text-decoration-none'><span className='txt ms-2 lnk'>Register here</span></Link>
                        </div>
                    </form>
                </div>
            </section>
